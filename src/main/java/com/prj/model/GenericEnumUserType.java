 ...
 *         and http://community.jboss.org/wiki/Java5EnumUserType
 * 
 */
public class GenericEnumUserType implements UserType, ParameterizedType {
	...
	public void nullSafeSet( PreparedStatement st , Object value , int index ) throws HibernateException, SQLException {
		...
		try {
			...
			throw new HibernateException( "Exception while invoking identifierMethod '" + identifierMethod.getName() + "' of " + "enumeration class '" + enumClass + "'" ,
				e );
		}
	}
