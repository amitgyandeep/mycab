  ...
  <div class="header-text hidden-xs">
    <div class="container">
                        <div class="col-md-5 tab-contact">
                            <h2>
                                <span style="background:#F36F21;">OSD Overview</span>
                            </h2>
                            <h3>
                            	<span class="col-lg-12">KEY MANAGEMENT TEAM</span>
<span class="col-lg-12">Investors</span>
<span class="col-lg-12"> Adventure Partners</span>
...
<div class="row">
     ...
     <div class="col-md-4 pull-right text-right">
       Home &gt; Fleet &gt; All Categories &gt;<a href="#"> Mercedes E Class</a>
      </div>
...
<div class="col-md-8 col-xs-pull4">
  <h3>MEET YOUR NEW WEEKEND CAR</h3> 
  <br>
  <p>Orange Self Drive is self-service, 24/7 car-sharing service, providing flexible reservations for 8 hours and beyond for inter / intra-city.<br>

We offer all-inclusive rates cover maintenance, insurance. Avail of tank full to tank full service &amp; minimal extra mile charges in the event you go more than 250 kms/day. At a flexible security deposit of Rs. 4,000/-, start your trip now!<br>

Orange Self Drive provides a safe mode of travel with dedicated call center and on road assistance.</p>
