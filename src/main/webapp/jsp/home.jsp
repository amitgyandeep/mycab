			...
			<div class="carousel-inner">
			    <div class="item">
                    ...
                    <div class="col-lg-4 tab-contact">
                      <s:actionerror/>
                      <form class="bookform form-inline row" id="form1" action="availability"  method="post">
                                  <div class="row">
                                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                  <input type="text" onkeydown="return false;" id="datepicker1" required="" placeholder="Pick Up Date" class="form-control hasDatepicker" name="customerRequestModel.startDate" value='<s:property value="%{#request.startDate}"/>'>
                                 ...
                                 <span></span>
                                  ...
                                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                  <input type="text" id="datepicker2" required="" onkeydown="return false;" placeholder="Drop Off Date" class="form-control hasDatepicker" name="customerRequestModel.endDate" value='<s:property value="%{#request.endDate}"/>'>
                                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                  </div>
                                 </div>
                                 <div class="form-group col-lg-6 col-sm-6 col-xs-12">
			    ...
			    <div class="item active">
                    ...
                    <s:actionerror/>
                      <form class="bookform form-inline row" id="form2" action="availability" theme="simple" method="post">
                                  ...
                                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                  <input type="text" id="datepicker3" onkeydown="return false;" placeholder="Pick Up Date" class="form-control hasDatepicker" name="customerRequestModel.startDate" required="" value='<s:property value="%{#request.startDate}"/>'>
                                   <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                  </div>
                                  </div>
                                 <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                               ...
                               <s:select class="form-control" style="color:gray;"
                                  ...
                                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                  <input type="text" id="datepicker4" onkeydown="return false;" placeholder="Drop Off Date" class="form-control hasDatepicker" name="customerRequestModel.endDate" required="" value='<s:property value="%{#request.endDate}"/>'>
                                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                  </div>
                                 </div>
                                 <div class="form-group col-lg-6 col-sm-6 col-xs-12">
			    ...
			    <div class="item">
                    ...
                    <div class="col-lg-4 tab-contact">
                      ...
                      <form class="bookform form-inline row" id="form3" action="availability" theme="simple" method="post">
                                  ...
                                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                  <input type="text" id="datepicker5" required="" onkeydown="return false;" placeholder="Pick Up Date" class="form-control hasDatepicker" name="customerRequestModel.startDate" value='<s:property value="%{#request.startDate}"/>'>
                                   <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                  </div>
                                  </div>
                                 <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                 <span></span>   <s:select class="form-control" style="color:gray;"
                                  ...
                                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                  <input type="text" id="datepicker6"  required="" onkeydown="return false;" placeholder="Drop Off Date" class="form-control hasDatepicker" name="customerRequestModel.endDate" value='<s:property value="%{#request.endDate}"/>'>
                                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                  </div>
                                 </div>
                                 <div class="form-group col-lg-6 col-sm-6 col-xs-12">
